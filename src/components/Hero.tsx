  ...
  return (
    <div id="hero" className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl">
        ...
        <motion.h1 
          className="text-4xl md:text-7xl font-bold tracking-tighter leading-[1.1] mb-12 max-w-5xl mx-auto"
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.2, duration: 0.8 }}
        >
          "What I cannot create, <br />
          <span className="text-brand-accent italic font-serif">I do not understand</span>."
          <div className="mt-4 text-sm font-mono uppercase tracking-[0.4em] text-gray-500">— Richard Feynman</div>
        </motion.h1>
