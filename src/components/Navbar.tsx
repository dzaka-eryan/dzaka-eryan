  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 px-6 py-6 flex justify-between items-center bg-brand-bg/80 backdrop-blur-md border-bottom border-brand-border">
      ...
      <div className="flex gap-4 items-center">
        <a href="#" className="hover:text-brand-accent transition-colors"><Github size={18} /></a>
        <a href="#" className="hover:text-brand-accent transition-colors"><Linkedin size={18} /></a>
        <a href="mailto:contact@example.com" className="bg-brand-accent text-brand-bg px-4 py-2 rounded-full text-xs font-bold uppercase tracking-wider hover:scale-105 transition-transform">
          Kontak
        </a>
      </div>
    </nav>
